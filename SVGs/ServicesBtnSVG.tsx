const ServicesBtnSVG = () => {
  return (
    <svg
      ...
      className="max-[426px]:scale-[1.2] origin-center max-[769px]:scale-[1.8] max-[1349px]:scale-[2.2] max-[1441px]:scale-[3] max-[1906px]:scale-[3] min-[1906px]:scale-[3]"
    >
      <path

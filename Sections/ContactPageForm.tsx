...
const ContactPageForm = () => {
  return (
    <div className="max-[769px]:w-[90%] max-[1281px]:w-[85%] w-[90%] 2xl:w-1/2 mx-auto relative top-50 z-[65] pb-60">
      <div
        ...
        >
          <div className="relative">
            <SectionHeading 
                ...
                btnIcon={<WordsBtnSVG />}
                className="py-15"
                style='text-[8rem]/[9rem]'
            />
            <div className="w-3/4 mx-auto pb-15 max-[769px]:w-4/5">
              <div>
                <Form action="">

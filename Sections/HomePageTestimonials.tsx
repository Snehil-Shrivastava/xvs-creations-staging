...
const HomePageTestimonials = () => {
  return (
    <div className='mt-30 pb-40'>
        ...
        <p className='text-[#F3EDDE] font-apercu-regular md:max-lg:tracking-wide md:max-lg:text-[0.75rem] lg:max-xl:text-[1rem] xl:max-1440p:text-[1.125rem] font-thin text-center'>Hear from visionaries and experts</p>

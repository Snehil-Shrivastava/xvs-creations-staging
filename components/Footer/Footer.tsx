        ...
        <div className="mx-auto pb-[72px] max-[769px]:pb-[32px]">
          <div className="mx-auto">
            <div className="border-b border-b-[rgba(247,152,57,0.1)]">
              <div className="flex gap-[48px] items-center justify-between lg:max-xl:pt-[88px] xl:max-1440p:pt-[111px] lg:max-xl:pb-[60px] xl:max-1440p:pb-[70px] mx-auto lg:max-1440p:w-[85%]">
                <div className="flex-1 max-[769px]:flex-none">
                  <h1
                    className={`lg:max-xl:text-[2.5rem]/[3.5rem] xl:max-1440p:text-[3rem]/[4rem] tracking-wider xl:max-1440p:w-full font-calSans`}
                  >
                ...
                <div className="flex-1 text-center flex justify-center">
                  <Link
                    href="/"
                    className="flex items-center text-nowrap bg-[#F79839] lg:max-xl:px-4 xl:max-1440p:px-5 lg:max-xl:py-3 xl:max-1440p:py-4 lg:max-xl:rounded-[32px] xl:max-1440p:rounded-[48px] lg:max-xl:text-xl xl:max-1440p:text-2xl lg:max-xl:gap-3 xl:max-1440p:gap-4 font-semibold"
                  >
                    <div>
                      <FooterBtnSVG />
                    </div>
            ...
            <div className="footer-links-block max-[426px]:mx-auto mt-[22px] max-[769px]:w-[85%] max-[769px]:mx-auto max-[1026px]:w-[85%] max-[1026px]:mx-auto max-[1026px]:mt-[44px] max-[1441px]:w-[85%] max-[1441px]:mx-auto max-[1441px]:mt-[58.58px] min-[1536px]:w-[90%] min-[1536px]:mx-auto max-[426px]:w-9/10 max-[426px]:mt-[22px]">
              ...
              <div className="footer-link-block second flex-[0.65] max-[1906px]:flex max-[1906px]:justify-center max-[1441px]:flex max-[1441px]:justify-center max-[426px]:justify-end">
                <div className="max-[1025px]:mx-auto max-[1441px]:flex max-[1441px]:flex-col max-[1441px]:h-full max-[426px]:w-[80%] max-[769px]:w-auto max-[1026px]:w-[80%] max-[769px]:mx-0">
                  <h1 className="font-semibold lg:max-xl:text-[16px] xl:max-1440p:text-[18px] lg:max-xl:pb-[22px] xl:max-1440p:pb-[26px]">
                    Contacts
                  </h1>
                  <p className="lg:max-xl:text-[12px] xl:max-1440p:text-[14px] font-extralight">
                  ...
                  <div className="flex gap-[32px] mt-[72px] max-[1441px]:mt-auto max-[1026px]:mt-[52px] max-[769px]:gap-[44px] max-[769px]:mt-[22px] max-[426px]:flex-col max-[426px]:mt-[22px] max-[426px]:gap-0">
                    <h1 className={`lg:max-xl:text-[46px] xl:max-1440p:text-[53px] font-calSans`}>
                      Say Hi!
                    </h1>
                    <div className="flex flex-col justify-center">
                      <Link
                        href="mailto:info@xvscreations.com"
                        className="hover:underline lg:max-xl:text-[12px] xl:max-1440p:text-[14px] font-extralight"
                      >
              ...
              <div className="footer-link-block third flex-[0.2]">
                ...
                <div className="flex flex-col lg:max-xl:gap-[6px] xl:max-1440p:gap-[8px] lg:max-xl:text-[12px]  xl:max-1440p:text-[14px]">

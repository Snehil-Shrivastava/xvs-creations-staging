...
export const cardsData = [
    {
        ...
        image: (
            <Image
                className="aspect-auto md:max-lg:w-[300px] lg:max-xl:w-[380px] xl:max-1440p:w-[450px]"
    ...
    },
    {
        ...
        image: (
            <Image
                className="aspect-auto md:max-lg:w-[300px] lg:max-xl:w-[380px] xl:max-1440p:w-[470px]"
                src={BrandingImg}
                alt="image"
            />
        )

    ...
    <div ref={mainContainerRef} className="h-[150vh] pointer-events-none">
      ...
      >
        ...
        >
          <div
            ...
            style={{
              boxShadow: "0 0 150px 180px rgba(196,102,8,0.05)",
            }}
          ></div>
          <div className="relative h-full">
            ...
            <div ref={svgRef} className={`absolute`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="268"
                height="287"
      ...
      >
        <svg
          ...
          viewBox="0 0 217 172"
          fill="none"
          className="w-auto max-sm:h-20 sm:max-lg:h-35.5 lg:max-xl:h-43 min-[1906px]:h-70 mx-auto scale-[1] translate-x-[5px]"
        >
          <path
...
export default AboutPageRichText;
